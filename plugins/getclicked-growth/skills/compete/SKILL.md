...
- Use `web_search` / WebSearch to find publicly available competitor data
- Mark all metrics as UNVALIDATED (do not estimate or guess)
- Still produce all output files — competitive positioning analysis is valuable even without exact traffic and keyword numbers
- Tell the user: "I worked with publicly available data. Connect the research tools for exact keyword volumes, rankings, and traffic estimates."
