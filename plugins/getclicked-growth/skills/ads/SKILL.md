...
"The Honest Take" is the signature pattern -- stop reporting and start advising.
...
## Revenue model
[Revenue per conversion, avg LTV, what counts as a conversion]

## Spend-to-revenue projection

### Conservative (Month 1-2)
[Explain assumptions: no quality score yet, cold traffic]

| Monthly Spend | Avg CPC | Clicks | CVR | Conversions | Revenue | CAC | ROAS |
|...|

### Optimized (Month 3+)
[What changes and why: quality score improving, negatives pruned]
...
## Breakeven analysis
[When does this pay for itself? Be specific.]

## The honest take
[Stop reporting, start advising. Name the trade-offs. Say what's uncomfortable.
"First-visit ROAS is below 1.0x. Here's why it's still worth it:"]
...
[Ranked list of levers -- what improves results fastest]

## Recommendation
[Specific: start at $X/month, expect Y, revisit after Z weeks]

## Assumptions
[Every assumption documented. Transparent.]
...
[Why this split -- which ad groups get more and why. Tie to persona priority and keyword opportunity.]

## Scaling rules
[When to increase: CPA thresholds, conversion velocity. When to cut: waste signals, diminishing returns.]
