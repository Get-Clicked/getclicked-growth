...
[Executive summary: 2-3 sentences -- site health grade, top 3 priorities, the one insight that changes the strategy.]
...
1. [Insight that surprises -- "The AI agent category is Lindy's to own." Not "consider targeting more keywords."]
...
[Executive summary: 2-3 sentences -- overall technical health, top 3 issues to fix immediately.]
...
## On-page issues
[Content gaps, missing meta descriptions, thin pages, keyword cannibalization. Written as narrative with specifics, not a generic checklist.]

## Recommendations
[Prioritized list -- what to fix first and why. Each item is a specific action, not a category.]
